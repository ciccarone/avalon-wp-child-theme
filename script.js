...
jQuery(document).ready(function( $ ) {
    ...
    if (!isMobile) {
      $(window).scroll(function() {
        $('.big-blocks--before').each(function() {
          if (isScrolledIntoView(this) === true) {
            $('.vc_custom_1607987548395').addClass('show animate__animated animate__fadeInLeft');
            $('.vc_custom_1607987761703').addClass('show animate__animated animate__fadeInRight');
          }
        });
